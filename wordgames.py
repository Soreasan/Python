# Kenneth Adair
# Following a long with  Learning to Program Part 2 on Pluralsight
# This is a word game that demos functions, lists, strings
...
def process_letter(letter, secret_word, blanked_word):
    ...
    #Loops up to and including the second parameter
